...
//  B+ Trees
//
//  Created by Aadarshraj Sah on 10/04/22.
// C++ program for implementing B+ Trees
...
void BPTree::insertInternal(int x, Node* cursor, Node* child)
{
    ...
    // For overflow, break the node
        ...
        // For new Interval
        Node* newInternal = new Node(MAX2);
        index_nodes++;
